...
public class DepositPanel extends JPanel {
    ...
    public DepositPanel() {
        ...
        accountLabel = new JLabel("Into Account number : ");
        ...
        JLabel banner = new JLabel("This is a DEPOSIT window");
    ...
    private class OkListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (numberEntered.length() == 0 || amountEntered.length() == 0
                ...
                message.setText("Account number should be exact 8 digits");
                ...
                if (Double.parseDouble(amountEntered) < 0) {
                    message.setText("Amount cannot be a negative");
                    message.setFont(font2);
                    message.setForeground(Color.red);
                } 
                else 
                {
                    ...
                    try {
                        ...
                        URL url = new URL("https://webbank-gvasilski.rhcloud.com/MakeDeposit");
